# Generated by Django 5.2.12 on 2026-03-27 03:09
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("DRAFT", "Draft"),
                            ("POSTED", "Posted — Awaiting Carrier"),
                            ("ASSIGNED", "Carrier Assigned"),
                            ("PICKUP_PENDING", "Driver En Route to Pickup"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "proof_signature",
                    models.TextField(blank=True, help_text="Base64 signature or name"),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["status", "created_at"], name="orders_frei_status_38cfc6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="freightorder",
            index=models.Index(
                fields=["shipper", "status"], name="orders_frei_shipper_843d1c_idx"
            ),
        ),
    ]
